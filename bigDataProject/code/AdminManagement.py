...
# 加载数据
data = pd.read_csv('processedDataForAdmin.csv')
...
# 将SHAP值存储到文本文件
np.savetxt('shap_values_positive_class_admin.txt', shap_values[1], fmt='%f')

print("SHAP values saved to shap_values_positive_class.txt_admin.")
