...
# 加载数据
data = pd.read_csv('processedDataForJobParam.csv')

# 随机抽取一定数量的样本
sample_size = 10000  # 每个数据集的样本数
...
# 将SHAP值存储到文本文件
np.savetxt('shap_values_positive_class.txt', shap_values[1 ], fmt='%f')

print("SHAP values saved to shap_values_positive_class.txt.")
